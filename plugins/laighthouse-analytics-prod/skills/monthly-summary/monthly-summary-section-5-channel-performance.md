...
<div class="card" style="margin-bottom:16px;">
  <div class="section-title">매체 성과 비교 ({M0_YY}년 {M0_MM}월) 및 전월 대비 증감율</div>
  <div style="overflow-x:auto;">
    <table>
      <thead>
        <tr>
          <th rowspan="2" style="vertical-align:middle; white-space:nowrap; text-align:center; border-right:1px solid #e2e8f0;">매체</th>
          <th colspan="2" style="vertical-align:middle; white-space:nowrap; text-align:center; border-bottom:none; padding-top:8px; padding-bottom:8px; vertical-align:middle; border-right:1px solid #e2e8f0;">광고비</th>
          <th colspan="2" style="vertical-align:middle; white-space:nowrap; text-align:center; border-bottom:none; padding-top:8px; padding-bottom:8px; vertical-align:middle; border-right:1px solid #e2e8f0;">매출</th>
          <th colspan="2" style="vertical-align:middle; white-space:nowrap; text-align:center; border-bottom:none; padding-top:8px; padding-bottom:8px; vertical-align:middle; border-right:1px solid #e2e8f0;">예약 완료</th>
          <th colspan="2" style="vertical-align:middle; white-space:nowrap; text-align:center; border-bottom:none; padding-top:8px; padding-bottom:8px; vertical-align:middle;">ROAS</th>
        </tr>
        <tr>
          <th style="vertical-align:middle; white-space:nowrap; text-align:center; font-size:11px; font-weight:500; padding-top:8px; padding-bottom:8px; vertical-align:middle;">{M1_MM}월</th>
          <th style="vertical-align:middle; white-space:nowrap; text-align:center; font-size:11px; font-weight:500; padding-top:8px; padding-bottom:8px; vertical-align:middle; border-right:1px solid #e2e8f0;">{M0_MM}월</th>
          <th style="vertical-align:middle; white-space:nowrap; text-align:center; font-size:11px; font-weight:500; padding-top:8px; padding-bottom:8px; vertical-align:middle;">{M1_MM}월</th>
          <th style="vertical-align:middle; white-space:nowrap; text-align:center; font-size:11px; font-weight:500; padding-top:8px; padding-bottom:8px; vertical-align:middle; border-right:1px solid #e2e8f0;">{M0_MM}월</th>
          <th style="vertical-align:middle; white-space:nowrap; text-align:center; font-size:11px; font-weight:500; padding-top:8px; padding-bottom:8px; vertical-align:middle;">{M1_MM}월</th>
          <th style="vertical-align:middle; white-space:nowrap; text-align:center; font-size:11px; font-weight:500; padding-top:8px; padding-bottom:8px; vertical-align:middle; border-right:1px solid #e2e8f0;">{M0_MM}월</th>
          <th style="vertical-align:middle; white-space:nowrap; text-align:center; font-size:11px; font-weight:500; padding-top:8px; padding-bottom:8px; vertical-align:middle;">{M1_MM}월</th>
          <th style="vertical-align:middle; white-space:nowrap; text-align:center; font-size:11px; font-weight:500; padding-top:8px; padding-bottom:8px; vertical-align:middle;">{M0_MM}월</th>
        </tr>
      </thead>
      <tbody>
...
- **모든 헤더 `<th>`에 `vertical-align:middle`과 상하 대칭 패딩(`padding-top:8px;
  padding-bottom:8px;`)을 명시적으로 적용한다** — 지표명(광고비 등) 헤더가 살짝 아래로
  치우쳐 보일 수 있다. `rowspan="2"`인 "매체" 헤더와
  `colspan="2"`인 지표명 헤더, 그 아래 월 표기 헤더까지 전부 상하 패딩을 동일하게 준다
  (지표명 행과 월 표기 행을 시각적으로 더 가깝게 붙이려고 일부러 비대칭을 주지 않는다 —
  정확한 상하 중앙 정렬이 항상 더 우선한다).
...
- **M0 셀 값 자체는 색을 입히지 않는다**(기본 텍스트 색상). 값 아래에 M-1 대비 변화량을 작게,
  **화살표(▲/▼)와 함께 괄호로 감싸** 중앙 정렬로 표시한다 (예: `(▲ +3.1%)`, `(▼ -0.1%p)`):
  ...
  - **네 지표 전부 "증가=빨강(`#dc2626`)/감소=파랑(`#2563eb`)/무변화=검정(`#1e293b`)"이다.**
    **"무변화"는 화면에 표시되는(반올림된) 값을 기준으로 판단한다** — 원본 수치가 미세하게
