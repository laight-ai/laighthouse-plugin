...
**report_type:** `mtd` — **브리즘(airbridge 기반, type-b) 전용** (항상 포함). 매체별 목표 대비
소진/달성 현황.
...
매출이 정상적으로 존재하는 버그가 확인됐다. 이 호출은 섹션 1이 이미 호출했다면(매번 실행하는
...
<div class="card" style="margin-bottom:16px;">
  ...
  <table>
    <thead><tr>
      <th style="border-right:1px solid #e2e8f0;">매체</th>
      <th>월 예산</th><th>소진액</th><th style="border-right:1px solid #e2e8f0;">예산 소진율</th>
      <th>목표 매출</th><th>광고 매출</th><th style="border-right:1px solid #e2e8f0;">매출 달성률</th>
      <th>목표 ROAS</th><th>ROAS</th>
    </tr></thead>
    <tbody>
