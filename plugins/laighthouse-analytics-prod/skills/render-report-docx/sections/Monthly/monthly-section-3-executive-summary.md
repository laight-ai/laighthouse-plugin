# Monthly Section 3: Executive Summary — DOCX 출력 스펙

> 데이터 스펙: 스킬 폴더 기준 `../../shared/sections/monthly/monthly-section-3-executive-summary.md` 를 **먼저** 읽고, 이 파일의 출력 스펙을 적용한다.
